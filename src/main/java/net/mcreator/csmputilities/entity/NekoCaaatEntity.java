package net.mcreator.csmputilities.entity;
...
public class NekoCaaatEntity extends Monster {
	...
	public NekoCaaatEntity(EntityType<NekoCaaatEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(CsmpUtilitiesModEntities.NEKO_CAAAT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
